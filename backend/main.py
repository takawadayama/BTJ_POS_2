...
@app.get("/transactions/{transaction_id}/details/", response_model=List[schemas.TransactionDetail])
def read_transaction_details(transaction_id: int, db: Session = Depends(get_db)):
    details = crud.get_transaction_details(db, transaction_id=transaction_id)
    return details
